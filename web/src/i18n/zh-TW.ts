const zhTW: Record<string, string> = {
  ...
  "profile.denseLoad": "稠密權重載入",
  "profile.expertMatmul": "專家矩陣乘",
  "profile.sharedExpert": "共享專家",
  "profile.router": "路由",
  "profile.attention": "注意力",
  "profile.blockOverhead": "正規化/殘差",
  ...
  "profile.overlapped": "專家原始讀取耗時",
  "profile.window": "視窗 · 最近 {{n}} 輪",
  "profile.throughputTitle": "每輪生成速度",
  ...
  "profile.oneTurn": "1 輪",
  "profile.diskNote": "磁碟服務是讀取路由專家的累計耗時；稠密權重載入則另行統計每層非路由權重的同步裝載。一般模式可讓專家讀取與運算重疊，因此只有運算執行緒實際感受到的等待才計入總耗時分解；低記憶體模式會同步讀取，磁碟服務時間也會計入 I/O 等待。多 KV 工作階段時，份額描述的是整個引擎在該輪視窗內的表現。",
